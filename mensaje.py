...
client = nexmo.Client(key="68e765fc", secret="umyVeI3qirUqu5wM")
...
def enviar_sms():
    ...
    telefono = '+573102430073'  

    mensaje = f"El cliente/a {nombre}, solicita {cantidad} de {producto}. ¡Gracias por tu pedido!  ahora se enviar mensajes gracias por contar con nosotoros"
